...
public class OSSClientUtil implements Serializable {
	 public static final Logger logger = LoggerFactory.getLogger(OSSClientUtil.class);
	private static final long serialVersionUID = -3372690407900737009L;
	// endpoint
	    private String endpoint = "oss-cn-beijing.aliyuncs.com";  
	    // accessKey  
	    private String accessKeyId = "LTAITRLI4TFbCLZF";  
	    private String accessKeySecret = "LcM3XfBQkyybRDEJuwyHtCCZIwHssv";  
	    // 空间  
	    private String bucketName = "orange1111";  
	    // 文件存储目录  
