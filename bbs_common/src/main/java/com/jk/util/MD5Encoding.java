...
*************************************************/  
public class MD5Encoding  implements Serializable {
  /* 下面这些S11-S44实际上是一个4*4的矩阵，在原始的C实现中是用#define 实现的， 
    这里把它们实现成为static final是表示了只读，且能在同一个进程空间内的多个 
    Instance间共享*/  
  ...
  private static final long serialVersionUID = 7796503648029037136L;
   ...
   * @return 变换完的结果，这个结果是从公共成员digestHexStr取得的
   */
